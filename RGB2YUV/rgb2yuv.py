...
YUV_DICT = {"i420": I420, "yv12": YV12, "nv12": NV12, "nv21": NV21, "i422": I422, "yv16": YV16, "nv16": NV16,
    "nv61": NV61, "i444": I444, "yv24": YV24, "nv24": NV24, "nv42": NV42, }
# https://en.wikipedia.org/wiki/YUV
BT470 = torch.tensor([[0.299, 0.587, 0.114], [-0.14713, -0.28886, 0.436], [0.615, -0.51499, -0.10001], ])
BT709 = torch.tensor([[0.2126, 0.7152, 0.0722], [-0.09991, -0.33609, 0.436], [0.615, -0.55861, 0.05639], ])
BT_DICT = {"h": BT470, "s": BT709, }
...
if __name__ == "__main__" and __doc__:
    ...
    with open(args["<out>"], mode="wb") as f:
        f.write(bytes(out.tolist()))  # ex: fold-method=marker
